...
<body>
		...
		<jsp:include page="header.jsp"/>
			...
			<div class="content_wrap_h">
				...
				<section class="deliver_h">
					...
					<div class="section_h">
						<p>받으시는 분</p>
						<input type="text" name="receiver_name" width="100%">
					</div>
					<div class="section_h">
						<p>받으시는 분 번호</p>
						<input type="text" name="receiver_name" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td class="coupon_submit">
										<button id="coupon_submit_h">적용</button>
										<button id="remove_coupon_submit">미적용</button>
	...
	<div class="coupon_modal_h">
				...
				<table>
					<tr>
						<th class="coupon1"></th>
						<td ><p>2개</p><button onclick="coupon1_submit1()">적용</button></td>
					</tr>
					<tr>
						<th class="coupon2"></th>
						<td><p>2개</p><button onclick="coupon1_submit2()">적용</button></td>
						</tr>
					<tr>
						<th class="coupon3"></th>
						<td><p>2개</p><button onclick="coupon1_submit3()">적용</button></td>
					</tr>
				</table>
			</div>
</body>
