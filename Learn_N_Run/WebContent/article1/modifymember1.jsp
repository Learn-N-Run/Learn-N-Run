...
//             if(!reg.test(pwd)){
//                 $("#newpwdErr").text("비밀번호 형식이 바르지 않습니다.");
//             }else{ $("#newpwdErr").text('');}
//         }
//     });
	...
	<div class="conatiner">
		<div class="mt-5 p-5 rounded" style="background-color: #f5f6f7;">
			...
			<div class="row mb-4">
				...
				<div class="col-4"><input type="password" class="form-control" id="pwd" name="pwd"></div>
			</div>
			<div class="row mb-4">
				<div class="col-4" style="text-align: right">
				<label for="newpwd"><span class="text-danger">*</span> 새 비밀번호</label></div>
			...
			<div class="row mb-4">
				<div class="col-4" style="text-align: right">
				<label for="newpwdCkd"><span class="text-danger">*</span> 새 비밀번호 확인</label></div>
