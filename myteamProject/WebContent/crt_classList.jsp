...
<link rel="stylesheet" href="css/crt_classList.css?ba">
...
%>			
				<div>
					<div id="class_image">
   						<img src="<%=m.getImg() %>" alt="1">
   					</div>
							
					<div id="class_name">
						<div class="class_name_1">클래스명</div>
						<div class="class_name_2"><%=m.getSubject() %></div>
					</div>
...
%>				
	...
	2. '클래스 새로 생성' 버튼 눌렸을 때 insert 실행되도록. (Ajax, keyUp)
